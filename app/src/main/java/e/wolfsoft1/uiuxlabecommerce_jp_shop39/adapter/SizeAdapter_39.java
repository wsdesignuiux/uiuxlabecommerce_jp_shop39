...
public class SizeAdapter_39 extends RecyclerView.Adapter<SizeAdapter_39.MySizeHolder> {

    private final ArrayList<Size_Model_39> size_modelArrayList;
    private final Context context;
    private int position;

    public SizeAdapter_39(Context context, ArrayList<Size_Model_39> size_modelArrayList) {
    ...
    public MySizeHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_size_39, viewGroup, false);
