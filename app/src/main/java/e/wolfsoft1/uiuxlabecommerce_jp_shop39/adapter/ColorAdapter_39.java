...
import e.wolfsoft1.uiuxlabecommerce_jp_shop39.R;
import e.wolfsoft1.uiuxlabecommerce_jp_shop39.model.Color_Model_39;

public class ColorAdapter_39 extends RecyclerView.Adapter<ColorAdapter_39.MyColorHolder> {

    private final Context context;
    private final ArrayList<Color_Model_39> color_modelArrayList;
    private int position;

    public ColorAdapter_39(Context context, ArrayList<Color_Model_39> color_modelArrayList) {
    ...
    public MyColorHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_color_39, viewGroup, false);
